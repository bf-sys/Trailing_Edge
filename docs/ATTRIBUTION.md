...
| Meteoroid hazard sprite (`hazards/hazard_meteoroid.png`) | AI-generated (2026-08-19/20) via the new art Generate-Evaluate-Refine loop (`art-generator-agent.md`/`art-evaluator-agent.md`/`art-refiner-agent.md`) / Gemini, replacing the flat generated placeholder circle. Passed evaluation round 1 clean. Chroma-keyed and auto-cropped by `tools/asset-prep/chroma-key.js`. No third-party source. See `docs/history/art-eval-log-2026-08-19.md`. |
