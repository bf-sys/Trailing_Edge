...
For the original desktop-app run's findings before the Agent 3 re-run, see `docs/history/run-log-2026-07-24.md`. For the full asset-reassignment detail behind the 2026-07-29 changes above, see `docs/STATUS.md`.
