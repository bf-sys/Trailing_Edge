...
- [x] **Ion Storm vs. Nebula Field — do they read as visually distinct in motion?** Checked only as a static-image comparison so far; needs a real in-engine playtest at the week-2 accessibility gate.
